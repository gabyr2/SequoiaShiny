...
# loggers
loggers <- readRDS(file = "./Data/hourlyLoggers.rds")

# USGS Marble Fork Kaweah NO3-N
usgs <- readRDS(file = "./Data/usgsStationWQ.rds")

# spatial
spatial <- read_csv(file = "./Data/lakeSpatialData.csv")

# secchi
secchi <- read_csv(file = "./Data/secchi.csv")

# YSI depth profiles
ysi <- read_csv(file = "./Data/YSI_Clean.csv")

# water chemistry & nutrients
watchem <- read_csv(file = "./Data/waterchem.csv")
watnutr <- read_csv(file = "./Data/waternutr.csv")

# sediment copper
sed <- read_csv(file = "./Data/sediment.csv")

# tadpoles morphology, copper, & histology
tad <- read_csv(file = "./Data/tadpole.csv")
histo <- read_csv(file = "./Data/histology.csv")

# periphyton chl.a, AFDM, & copper
per_chlafdm <- read_csv(file = "./Data/periChlaAfdm.csv")
per_cu <- read_csv(file = "./Data/periphytonCu.csv")
